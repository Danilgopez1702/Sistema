<?php
    //Realizamos una consulta a la tabla reportes  
        ...
        $razon_rechazo = $extraccion_reporte['razon_rechazo'];
        $problema_encontrado = $extraccion_reporte['problema_reportes'];
        $segunda_solucion = $extraccion_reporte['solucion_rechazo'];
        $fecha_reporte = date("Y-m-d", strtotime( $extraccion_reporte['fecha_reportes']));
        $fecha_rechazo = date("Y-m-d", strtotime( $extraccion_reporte['fecha_rechazo']));
        $fecha_reagendado = date("Y-m-d", strtotime( $extraccion_reporte['fecha_segunda_visita']));

    //Realizamos una consulta a la tabla clientes
    ...
    //Realizamos una consulta a la tabla usuario para sacar el agente que realizo el reporte
    ...
    //Realizamos una consulta a la tabla usuario para sacar el tecnico asignado al reporte
