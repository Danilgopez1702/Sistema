...
$filename = "digitalnet_clientes_morosos_inactivos_" . date("d-m-Y");         //File Name
...
$sql = mysqli_query($conexion, "SELECT `id_cliente`, `numero_cliente`, `folio_cliente`, `status_cliente`, `paquete_cliente`, `velocidad_cliente`, `precio_cliente`, `fecha_instalacion`, `fecha_corte`, `ip_cliente`, `vendedor_cliente`,
 ...
 `ref_nombre1`, `ref_tel1`, `ref_nombre2`, `ref_tel2`, `radio_cliente`, `es_fibra`, `router_cliente`, `onu_cliente`, `bandera_cliente`, `bote_cliente`, `puerto_cliente`, `factura`, `por_revisar`, `id_zona`, `cron_checador`, `TIMESTAMP` FROM `cliente` WHERE `status_cliente`=3");
