...
$filename = "inventar_clientes_cancelados_" . date("d-m-Y");         //File Name
...
`bandera_cliente`, `bote_cliente`, `puerto_cliente`, `factura`, `por_revisar`, `id_zona`, `cron_checador`, `TIMESTAMP` FROM `cliente` WHERE `status_cliente` = 6");
