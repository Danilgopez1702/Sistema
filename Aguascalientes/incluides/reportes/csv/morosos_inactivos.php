<?php
    ...
    $filename = "Morosos_Inactivos";         //File Name
    ...
    $sql = mysqli_query($conexion, "SELECT tel1_cliente , numero_cliente from cliente WHERE status_cliente = 3");
    $sql2 = mysqli_query($conexion, "SELECT tel2_cliente , numero_cliente from cliente WHERE status_cliente = 3");
