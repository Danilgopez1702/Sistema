<?php
    ...
    $filename = "Equipo_Por_Recuperar";         //File Name
    ...
    $sql = mysqli_query($conexion, "SELECT tel1, num_cliente from clientes WHERE status = 5");
    $sql2 = mysqli_query($conexion, "SELECT tel2, num_cliente from clientes WHERE status = 5");
