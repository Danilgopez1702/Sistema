...
if (
    ...
    if ($instalacion_nueva == 1) {
        ...
        `radio_cliente`,`factura`, `por_revisar`, `encuesta_cliente`, `id_zona`) VALUES ('$n_cliente','$folio',
        ...
        '$tel1','$tel2','$tel3','$ref1','$ref_tel','$ref2','$ref_tel2','$ref_tel2','$ref_tel2', '$antena', 1, 2, 2, 1)");
        ...
        $sql_revisar = mysqli_query($conexion, "INSERT INTO `por_revisar`( `id_cliente`, `status_revisar``)
        VALUES ('$id',1)");
        ...
        `factura`, `por_revisar`,, `encuesta_cliente` `id_zona`) VALUES ('$n_cliente','$folio',
        0,'$paquete','$velocidad','$precio_m','$fecha_instalacion','$fecha_corte','$vendedor','$instalador','$nombre',
        '$paterno','$materno','$nacimiento','$email','$calle','$n_ext','$n_int','$municipio','$estado','$colonia','$postal','$calle1','$calle2','$ref',
        '$tel1','$tel2','$tel3','$ref1','$ref_tel','$ref2','$ref_tel2','$ref_tel2','$ref_tel2', '$router', '$onu', '$bandera', '$bote', '$puerto', 1, 2, 2, 1)");
        $sql_id = mysqli_query($conexion, "SELECT * FROM `cliente` WHERE numero_cliente = '$n_cliente'");
        $extraccion_id = mysqli_fetch_assoc($query_id);
        $id = $extraccion_id['id_cliente'];
        ...
        `numero_ext`, `numero_int`, `municipio`, `estado`, `colonia_cliente`, `codigo_postal`, `entre_calle1`, `entre_calle2`, 
        `ref_dom`, `tel1_cliente`, `tel2_cliente`, `tel3_cliente`, `ref_nombre1`, `ref_tel1`, `ref_nombre2`, `ref_tel2`,
        `ont_cliente`, `bandera_cliente`, `bote_cliente`, `puerto_cliente`, `factura`, `por_revisar`,, `encuesta_cliente` `id_zona`) VALUES ('$n_cliente','$folio',
        0,'$paquete','$velocidad','$precio_m','$fecha_instalacion','$fecha_corte','$vendedor','$instalador','$nombre',
        '$paterno','$materno','$nacimiento','$email','$calle','$n_ext','$n_int','$municipio','$estado','$colonia','$postal','$calle1','$calle2','$ref',
        '$tel1','$tel2','$tel3','$ref1','$ref_tel','$ref2','$ref_tel2', '$ont', '$bandera_ont', '$bote_ont', '$puerto_ont', 1, 2, 2, 1)");
