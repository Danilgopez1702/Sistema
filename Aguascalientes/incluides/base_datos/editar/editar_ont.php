...
if($_SESSION['rol'] == 3132 || $_SESSION['rol'] == 1){
                    ...
                    $mac_antes = $consulta['mac_ont_inventario'];
                    $onu_antes = $consulta['ont_inventario'];
                    ...
                    if($mac != $mac_antes){
                                        ...
                                        $mensaje ='Se cambio la ont del del equipo, de '.$onu_antes. ' a '.$onu;
                                        //agreagar a log
                                        $sql_log = mysqli_query($conexion, "INSERT INTO `log`( `accion_log`, `nombre_usuario`)
                                        VALUES ('$mensaje' ,'$id_usuario')");
                    ...
                    $sql = mysqli_query($conexion,"UPDATE `inventario` SET `mac_ont_inventario`= '$mac',`ont_inventario`= '$onu',`id_instalador`='$instalador',
