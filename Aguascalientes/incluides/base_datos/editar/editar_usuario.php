...
if($_SESSION['rol'] == 3132 || $_SESSION['rol'] == 1){
                    ...
                    $pass_antes = $consulta['usuario_usuario'];
                    ...
                    $sql = mysqli_query($conexion,"UPDATE `usuario` SET `tipo_usuario`= '$rol',`usuario_usuario`= '$nombre',
                    `md5`= '$cadena_cifrada',`pass_usuario`= '$pass',`status_usuario`= '$status',`zona_usuario`= 1 WHERE `id_usuario` = '$id' ");
