...
$sql_select = mysqli_query($conexion, "SELECT * FROM `inventario` WHERE `onu_inventario`= '$numont'");
...
$sql = mysqli_query($conexion, "INSERT INTO `inventario`(`onu_inventario`,`id_instalador`, `mac_inventario`,`fallo_inventario`, `tipo_inventario`,`id_zona`)
 VALUES ('$numont', 2,'$nummacont','$fallo',1,1)");

//el valor mensajes es para llamarlo en el log como string
$mensajes ='Se agrego el equipo con onu '.$numont .' y con mac'.$nummacont.' al inventario';
