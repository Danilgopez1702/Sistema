...
$sql = mysqli_query($conexion, "INSERT INTO `inventario`(`ont_inventario`,`id_instalador`, `mac_ont_inventario`,`fallo_inventario`, `tipo_inventario`,`id_zona`)
 VALUES ('$numont', 2,'$nummacont','$fallo',2,1)");
