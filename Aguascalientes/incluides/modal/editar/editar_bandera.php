                ...
                <div class="modal-body">
                    <form class="forms-sample" method='post' action='../../../base_datos/editar/editar_bandera.php' enctype="multipart/form-data">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="row-md-12">
                          <div class="form-group row">
                            <label class="col-sm-8 col-form-label">Bandera <span class="require">*</span></label>
                            <div class="col-sm-10">
                              <input type="text" class="form-control" id="editar_bandera_inventario" name="editar_bandera_inventario" required="" />
                            </div>
                          </div>
                        </div>
                        <div class="row-md-12">
