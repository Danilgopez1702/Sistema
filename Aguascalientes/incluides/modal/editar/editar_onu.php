        ...
        <div class="modal-content">
            ...
            <div class="container"></div>
                <div class="modal-body">
                    <form class="forms-sample" method='post' action='../../../base_datos/editar/editar_onu.php' enctype="multipart/form-data">
                      ...
                      <div class="col-md-12">
                        ...
                        <div class="row-md-12">
                          <div class="form-group row">
                            <label class="col-sm-8 col-form-label">MAC del equipo <span class="require">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="row-md-12">
                          <div class="form-group row">
                            <label class="col-sm-8 col-form-label">ONU del equipo <span class="require">*</span></label>
                            <div class="col-sm-10">
                        ...
                        <div class="row-md-12">
                          <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                        <select class="form-control" name="editar_id_instalador" id="editar_id_instalador" style="border-radius: 5px;" onchange='form_instalacion();'>
