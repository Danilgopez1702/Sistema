                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="vendedor" name="vendedor" value="<?php echo $nombre_reparador; ?>" disabled>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                    <input type="text" class="form-control col-sm-12" name="instalador" id="instalador" value="<?php echo $nombre_reparador; ?>" disabled>
                                    </div>
                                </div>
                            </div>
                            <!-- Tipo de Instalacion -->
...
<script src="../../../js/cliente/nuevo_cliente_tecnico.js"></script>
