    ...
    <form class="user" method="POST" action='../../../base_datos/subir/add_cliente.php'>
        ...
        <div class="card shadow col-sm-6 py-sm-2 m-sm-1">
            <div class="card-header py-sm-2">
                <h6 class="m-0 font-weight-bold text-primary">Asignar ONUS a Tecnico</h6>
            </div>
            <div class="py-sm-2 row">
                <div class="container text-left">
                    ...
                    <div class="row col-mb-3">
                        ...
                        <div class="col-sm-6">
                            <select class="form-control" name="instalador_onu" id="instalador_onu" style="border-radius: 5px;">
