    ...
    <form class="user" method="POST" action='../../../base_datos/subir/add_cliente.php'>
        ...
        <div class="card shadow col-sm-6 py-sm-2 m-sm-1">
            <div class="card-header py-sm-2">
                <h6 class="m-0 font-weight-bold text-primary">Asignar Antenas a Tecnico</h6>
            </div>
            <div class="py-sm-2 row">
                <div class="container text-left">
                    ...
                    <!-- Ingresar antena a instalador -->
                    <div class="row col-mb-3">
                        <label class="col-sm-6 col-form-label">Instalador<span class="require">*</span></label>
                        <div class="col-sm-6">
                            <select class="form-control" name="instalador_antena" id="instalador_antena" style="border-radius: 5px;">
...
<script src="../../../js/inventario/asignar/asignar_tecnico_radio.js"></script>
