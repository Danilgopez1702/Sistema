...
<div class="card shadow mb-4">
    ...
    <div class="card-body ">
        ...
        <table class="table table-sm" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
                <?php
                $query = mysqli_query($conexion, "SELECT * FROM `reportes` WHERE `tipo_reportes` = 2");
                ...
                ?>
                        <tr>
                            ...
                            <td>
                                <a href="../caratula/migraciones.php?id=<?php echo $data['id_reportes'] ?>" title='Ver reporte'><i class="fas fa-light fa-eye"></i></a>
                                <a title="Eliminar usuario" onclick="return confirm('Estás seguro que deseas eliminar el reporte: <?php echo $data['no_reporte_reportes']; ?>');" href="../../../base_datos/eliminar/eliminar_migracion.php?id=<?php echo $data['id_reportes'] ?>"><i class="fa fa-trash ml-2"></i></a>
                            </td>
                        </tr>
                <?php
                    }
