...
$id_cliente = $_GET['id'];
include "../../../procesos/procesos_encuesta.php";
include "../../../mikrotik/get_info.php";
?>
<h2>Consulta de Cliente</h2>
<div class="card shadow mb-4">
    <div class="card-header py-sm-2">
        <h4 class="m-0 font-weight-bold text-primary">Datos de <?php echo $nombre_completo ?> (Numero de cliente: <?php echo $num_cliente ?>)[Contrato Por Encuestar] .</h4>
    </div>
    <div class="card-body">
        <form class="forms-sample" method='post' id="formo" action='../../../base_datos/editar/editar_encuesta.php' enctype="multipart/form-data">
            <!-- Botones -->   
            <div class="panel-body text-right">
                <a href="../../../base_datos/editar/editar_revisar_si.php?id=<?php echo $id_cliente ?>" type="button" class="btn" style="background-color: #daa200; color: white;" >Cliente Mala Informacion</a>
                <a href="../../../base_datos/editar/editar_revisar_si.php?id=<?php echo $id_cliente ?>" type="button" class="btn" style="background-color: #daa200; color: white;" >Numeros Erroneos</a>
                <a href="../../../base_datos/editar/editar_revisar_si.php?id=<?php echo $id_cliente ?>" type="button" class="btn" style="background-color: #daa200; color: white;" >Numero Fuera del Area de Servicio</a>
                <a href="../../../base_datos/editar/editar_revisar_si.php?id=<?php echo $id_cliente ?>" type="button" class="btn btn-primary">Encuesta Realizada Correctamente</a>
            </div>
            <br>
            <!-- Datos del Contrato -->
            <div class="card shadow mb-4">
                ...
                <div class="">
                    <div class="container text-center">
                        <div class=" align-items-center">
                            ...
                            <div class="col-md-8">
                                <div class="form-inline">
                                    <label class="col-sm-4 col-form-label">Notas / Comentarios</label>
                                    <div class="col-sm-8">
                                        <textarea type="text" class=" col-sm-12" id="razon" name="razon"><?php echo $notas ?></textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <!-- Botones -->
            <div class="panel-body text-right">
                <a href="../../../base_datos/editar/editar_encuesta.php?id=<?php echo $id_cliente ?>&&tipo=1" type="button" class="btn" style="background-color: #daa200; color: white;" >Cliente Mala Informacion</a>
                <a href="../../../base_datos/editar/editar_revisar_si.php?id=<?php echo $id_cliente ?>&&tipo=2" type="button" class="btn" style="background-color: #daa200; color: white;" >Numeros Erroneos</a>
                <a href="../../../base_datos/editar/editar_revisar_si.php?id=<?php echo $id_cliente ?>&&tipo=3" type="button" class="btn" style="background-color: #daa200; color: white;" >Numero Fuera del Area de Servicio</a>
                <a href="../../../base_datos/editar/editar_revisar_si.php?id=<?php echo $id_cliente ?>&&tipo=4" type="button" class="btn btn-primary">Encuesta Realizada Correctamente</a>
            </div>
        </form>
    </div>
</div>
