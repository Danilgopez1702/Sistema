...
<div class="card shadow mb-4">
    ...
    <div class="card-body">
        <form class="forms-sample" method='post' id="formo" action='../../../base_datos/subir/add_cliente.php' enctype="multipart/form-data">
            ...
            <div class="panel-body text-right">
                <a href="" type="button" class="btn btn-info">Pago manual</a>
                <a href="../../../mikrotik/boton_arreglar.php?id=<?php echo $data['id_cliente'] ?>" type="button" class="btn btn-primary">Arreglar</a>
                <?php
                if (!$onu_cliente) {
                ?>
                    <a href="http://<?php echo $ip_reporte ?>" type="button" class="btn btn-secondary" target="_blank">Revisar Instalacion</a>
                <?php
                } else {
                ?>
                ...
                ?>
                <a href="../../../base_datos/editar/editar_cliente.php?id=<?php echo $data['id_cliente'] ?>" type="button" class="btn btn-success">Actualizar</a>
                <a href="../../../mikrotik/refresh.php?id=<?php echo $data['id_cliente'] ?>" type="button" class="btn btn-warning">Refresh</a>
            </div>
            <br>
            <!-- Datos del Contrato -->
            <div class="card shadow mb-4">
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control col-sm-12" name="paquete" id="paquete" style="border-radius: 5px;" required onchange='precio();'>
                                            <option selected="true"><?php echo $user_profile ?></option>
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control col-sm-12" id="ip" name="ip" value="<?php echo $ip_cliente ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="nombre" name="nombre" value="<?php echo $num_cliente ?>" required>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="ref_tel" name="ref_tel" value="<?php echo $ref_tel ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="ref2" name="ref2" value="<?php echo $ref2 ?>" required>
                                    </div>
                                </div>
                            </div>
            ...
            <br>
            <div class="panel-body text-right">
                <button type="button" id="btn_submit" class="btn btn-primary btn-icon-split btn-lg col-sm-2" onclick="formSubmit();">Actualizar</button>
            </div>
        </form>
    </div>
    <div class="panel-body text-left">
        ...
        if ($factura == 1) {
        ?>
            <a href="../../../base_datos/editar/cliente_facturacion.php?id=<?php echo $id_cliente ?>" type="button" class="btn btn-info">Activar Facturacion</a>
        <?php
        } else {
        ?>
            <a href="../../../base_datos/editar/cliente_facturacion.php?id=<?php echo $id_cliente ?>" type="button" class="btn btn-info">Desactivar Facturacion</a>
        <?php
        }
        ?>
        ...
        <a href="" type="button" class="btn btn-success">Activar Emby</a>
