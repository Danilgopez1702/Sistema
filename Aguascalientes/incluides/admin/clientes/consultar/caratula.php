...
<div class="card shadow mb-4">
    <div class="card-header py-sm-2">
        <h4 class="m-0 font-weight-bold text-primary">Datos de
            <?php echo $nombre_completo ?> (Numero de cliente:
            <?php echo $num_cliente ?>).
        </h4>
    </div>
    <div class="card-body">
        <form class="forms-sample" id="formo" name="formo" method='POST'
            action='../../../base_datos/editar/editar_cliente.php' enctype="multipart/form-data">
            <!-- Botones -->
            <div class="panel-body text-right">
                <a data-toggle="modal" href="#modal_agregar_pago" type="button" class="btn btn-info">Pago manual</a>
                <button type="button" class="btn btn-primary" id="btn_arreglar" name="btn_arreglar"
                    onclick="arreglar();">Arreglar</button>
                <?php
                if (!$radio_cliente) {
                    ?>
                    ...
                    ?>
                    <a href="https://<?php echo $ip_cliente ?>" type="button" class="btn btn-info" target="_blank">Revisar
                        Instalacion
                    </a>
                    <?php
                }
                ...
                <button type="button" class="btn btn-warning" id="btn_refresh" name="btn_refresh"
                        ...
                        <div class="form-row align-items-center">
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="folio" name="folio"
                                            maxlength="6" value="<?php echo $folio ?>" required>
                                    </div>
                                </div>
                            </div>
                            <!-- Numero de Cliente -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="n_cliente"
                                            name="n_cliente" value="<?php echo $num_cliente ?>" maxlength="10" required>
                                    </div>
                                </div>
                            </div>
                            <!-- Status de Cliente -->
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <select class="form-control col-sm-12" name="status" id="status"
                                            style="border-radius: 5px;" required onchange='precio();'>
                                            <option selected="true">
                                                <?php echo $status . " (Actual)" ?>
                                            </option>
                                            <?php
                                            if ($status_cliente == 0) {
                                            } else {
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control col-sm-12" id="fecha_instalacion"
                                            ...
                                            value="<?php echo date('Y-m-d', strtotime($instalacion_cliente)) ?>"
                                            required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control col-sm-12" id="fecha_corte"
                                            name="fecha_corte"
                                            value="<?php echo date('Y-m-d', strtotime($fecha_corte)) ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" class="form-control col-sm-12" id="ip" name="ip"
                                            value="<?php echo $ip_cliente . " (Actual)" ?>">
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="puerto_onu"
                                            name="puerto_onu" value="<?php echo $puerto_cliente ?>" maxlength="2">
                                    </div>
                                </div>
                            </div>
                            <!-- Seleccionar Onu -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="router" name="router"
                                            value="<?php echo $router_cliente ?>" maxlength="12">
                                    </div>
                                </div>
                            </div>
                            <!-- Seleccionar Bandera -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="puerto_ont"
                                            name="puerto_ont" value="<?php echo $puerto_cliente ?>" maxlength="2">
                                    </div>
                                </div>
                            </div>
                            <!-- Seleccionar Ont -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="paterno" name="paterno"
                                            value="<?php echo $p_cliente ?>" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="materno" name="materno"
                                            value="<?php echo $m_cliente ?>" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="date" class="form-control col-sm-12" id="nacimiento"
                                            name="nacimiento" value="<?php echo $fecha_nacimiento ?>" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="postal" name="postal"
                                            value="<?php echo $postal ?>" maxlength="5" require>
                                    </div>
                                </div>
                            </div>
                            <!-- Ingresar Estado -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="municipio"
                                            name="municipio" value="<?php echo $municipio ?>" require>
                                    </div>
                                </div>
                            </div>
                            <!-- Ingresar Colonia -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="colonia" name="colonia"
                                            value="<?php echo $colonia ?>" require>
                                    </div>
                                </div>
                            </div>
                            <!-- Ingresar Calle -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="n_ext" name="n_ext"
                                            value="<?Php echo $exterior ?>" require>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="n_int" name="n_int"
                                            value="<?php echo $interior ?>" require>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="tel1" name="tel1"
                                            maxlength="10" value="<?php echo $tel1 ?>" require>
                                    </div>
                                </div>
                            </div>
                            <!-- Ingresar Telefono 2 -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="tel2" name="tel2"
                                            maxlength="10" value="<?php echo $tel2 ?>" require>
                                    </div>
                                </div>
                            </div>
                            <!-- Ingresar Telefono 3 -->
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="tel3" name="tel3"
                                            maxlength="10" value="<?php echo $tel3 ?>" require>
                                    </div>
                                </div>
                            </div>
                            <!-- Ingresar Email -->
                        ...
                        <div class="form-row align-items-center">
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="ref_tel" name="ref_tel"
                                            maxlength="10" value="<?php echo $ref_tel ?>" required>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="ref2" name="ref2"
                                            maxlength="10" value="<?php echo $ref2 ?>" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 mb-3">
                                <div class="form-inline">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control col-sm-12" id="ref_tel2" name="ref_tel2"
                                            value="<?php echo $ref_tel2 ?>" required>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <br>
            <div class="panel-body text-right">
                <button type="button" class="btn btn-primary btn-icon-split btn-lg col-sm-2" id="btn_submit"
                    onclick="formSubmit();">Actualizar</button>
            </div>
        </form>
    </div>
    <div class="panel-body text-left">
        ...
        if ($factura == 1) {
            ?>
            <a href="../../../base_datos/editar/cambiar_facturacion.php?id=<?php echo $id_cliente ?>&&estado=1"
                type="button" class="btn btn-info">Activar Facturacion</a>
            <?php
        } else if ($factura == 2) {
            ?>
                <a href="../../../base_datos/editar/cambiar_facturacion.php?id=<?php echo $id_cliente ?>&&estado=2"
                    type="button" class="btn btn-info">Desactivar Facturacion</a>
                <a href="../facturacion/datos_facturacion.php?id=<?php echo $id_cliente ?>" type="button"
                    class="btn btn-primary" target="_blank">Ver Datos de Facturacion</a>
            <?php
        }
        ?>
