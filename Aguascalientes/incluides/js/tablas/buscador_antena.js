$(document).ready(function () {
    ...
    var table = $('#dataTable').DataTable({
      "ajax": {
        "url": "../../../base_datos/ajax/tablas/consulta_antenas.php",
  ...
  $(document).on("click", ".btnBorrar", function () {
    ...
    if (y) {
      window.location.href = "/digitalnetsistem/Aguascalientes/incluides/base_datos/eliminar/eliminar_inventario.php?id=" + user_id+"&&in=3";
    }
