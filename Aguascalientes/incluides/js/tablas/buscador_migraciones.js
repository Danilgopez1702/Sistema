$(document).ready(function () {
                    ...
                    $(document).on("click", ".btnAbrir", function () {
                      ...
                      window.location.href = "/Sistema/Aguascalientes/incluides/admin/reportes/caratula/revision.php?id=" + user_id+"&&tipo=3";
                    });
                    ...
                    $(document).on("click", ".btnBorrar", function () {
                      ...
                      if (y) {
                        window.location.href = "/Sistema/Aguascalientes/incluides/base_datos/eliminar/eliminar_reparacion.php?id=" + user_id+"&&in=2";
                      }
