$(document).ready(function () {
                    var table = $('#dataTable').DataTable({
                      "ajax": {
                        "url": "../../../base_datos/ajax/tablas/consulta_migraciones.php",
                    ...
                    $(document).on("click", ".btnAbrir", function () {
                      ...
                      window.location.href = "/digitalnetsistem/Aguascalientes/incluides/admin/reportes/caratula/migraciones.php?id=" + user_id;
                    });
                    ...
                    $(document).on("click", ".btnBorrar", function () {
                      ...
                      if (y) {
                        window.location.href = "/digitalnetsistem/Aguascalientes/incluides/base_datos/eliminar/eliminar_reparacion.php?id=" + user_id+"&&in=2";
                      }
