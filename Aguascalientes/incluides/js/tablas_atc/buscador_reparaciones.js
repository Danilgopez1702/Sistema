$(document).ready(function () {
                    var table = $('#dataTable').DataTable({
                      "ajax": {
                        "url": "../../../base_datos/ajax/tablas/consulta_reparaciones.php",
                    ...
                    $(document).on("click", ".btnAbrir", function () {
                      ...
                      window.location.href = "/Sistema/Aguascalientes/incluides/atc/reportes/caratula/reparaciones.php?id=" + + user_id+"&&tipo=2";
                    });
