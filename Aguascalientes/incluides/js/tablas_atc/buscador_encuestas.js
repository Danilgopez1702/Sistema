$(document).ready(function () {
    ...
    var table = $('#dataTable').DataTable({
      "ajax": {
        "url": "../../../base_datos/ajax/tablas/consulta_encuestas.php",
  ...
  $(document).on("click", ".btnBorrar", function(){
    ...
    console.log(user_id); 
    window.location.href = "/Sistema/Aguascalientes/incluides/atc/clientes/por_revisar/contrato_revisar.php?id=" + user_id;
