...
$sql2 = "SELECT * FROM datos_facturacion WHERE idClientes = ".$_GET['idClientes'];
...
$sql3 = "SELECT precio_mensual FROM clientes WHERE idClientes = ".$_GET['idClientes'];
//$sql3 = "SELECT precio_mensual FROM clientes WHERE idClientes = 1";
...
try {
    ...
    $d['LeyendaFolio'] = 'FACTURA GLOBAL';

    $d['Emisor']['RegimenFiscal'] = "601";
   
    $d['Receptor']['Rfc'] = $row2['rfc'];
    $d['Receptor']['Nombre'] =  $row2['nombre'];
    $d['Receptor']['ResidenciaFiscal'] =  $row2['null'];
    $d['Receptor']['NumRegIdTrib'] =  null;
    $d['Receptor']['UsoCFDI'] =  'G03';
    ...
    $d['Receptor']['DomicilioFiscalReceptor'] = $row2['codigo_postal'];
    $d['Receptor']['RegimenFiscalReceptor'] = $row2['regimen'];

    $d['Conceptos'][0]['ObjetoImp'] = '02';
    $d['Conceptos'][0]['ClaveProdServ'] = '01010101';
    $d['Conceptos'][0]['NoIdentificacion'] = '01';
    $d['Conceptos'][0]['Cantidad'] = 1.0;
    $d['Conceptos'][0]['ClaveUnidad'] = 'E48';
    $d['Conceptos'][0]['Unidad'] = 'SERVICIO';
    $d['Conceptos'][0]['Descripcion'] = 'Acceso a Internet Digital Net';
    ...
    $d['Conceptos'][0]['Traslados'][0]['Base'] = $subtotal;
    $d['Conceptos'][0]['Traslados'][0]['Impuesto'] = '002';
    $d['Conceptos'][0]['Traslados'][0]['TipoFactor'] = 'Tasa';
    $d['Conceptos'][0]['Traslados'][0]['TasaOCuota'] = '0.160000';
    $d['Conceptos'][0]['Traslados'][0]['Importe'] = $iva;
	...
	if ( $response->code == 200 ) {
		...
		try {
			...
			file_put_contents('xml/'.$last_id.'.xml', base64_decode($response->body->cfdi->XmlBase64));
