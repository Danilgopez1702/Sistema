...
// Get thickness parameter from $_GET:
	...
	$jpg_image = $image;//imagecreatefromjpeg('sunset.jpg');
	...
	// Print Text On Image
	imagettftext($jpg_image, 15, 0, 90, 120, $white, $font_path, $text);
	...
	if (isset($_GET['tipo'])) {
		if ($_GET['tipo'] == 'a') {
			$dest = imagecreatefromjpeg('tarjeta-a.jpg');
			$src = $jpg_image;

			// Copy and merge
			imagecopymerge($dest, $src, 22, 135, 0, 0, 491, 120, 100);
			...
			$dest = imagecreatefromjpeg('tarjeta-b.jpg');
			$src = $jpg_image;

			// Copy and merge
			imagecopymerge($dest, $src, 22, 125, 0, 0, 491, 120, 100);
			...
			$dest = imagecreatefrompng('tarjeta-a-b&w.png');
			$src = $jpg_image;
			...
			$dest = imagecreatefrompng('tarjeta-b-b&w.png');
			$src = $jpg_image;
