            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <a class="collapse-item" href="../../../reportes/xls/todos_los_clientes.php">Todos los Clientes</a>
                            <a class="collapse-item" href="../../../reportes/xls/clientes_activos.php">Clientes Activos</a>
                            <a class="collapse-item" href="../../../reportes/xls/clientes_por_vencer.php">Clientes Por Vencer</a>
                            <a class="collapse-item" href="../../../reportes/xls/clientes_morosos_activos.php">Clientes <br> Morosos Activos</a>
                            <a class="collapse-item" href="../../../reportes/xls/clientes_morosos_inactivos.php">Clientes <br> Morosos Inactivos</a>
                            <a class="collapse-item" href="../../../reportes/xls/clientes_cancelados.php">Clientes Cancelados</a>
                            <a class="collapse-item" href="../../../reportes/xls/Equipos_recuperados.php">Clientes <br> Equipos Recuperados</a>
                            <a class="collapse-item" href="../../../reportes/xls/equipos_no_recuperados.php">Clientes <br> Equipos No Recuperados</a>
                            <a class="collapse-item" href="../../../reportes/xls/dificil_recuperacion.php">Equipos de <br> Dificil Recuperacion</a>
                            <a class="collapse-item" href="../../../reportes/xls/historico_autorizacion_pagos_manual.php">Historico de <br> Autorizacion Pagos Manual</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../../../reportes/csv/morosos_inactivos.php">Morosos Inactivos</a>
                            <a class="collapse-item" href="../../../reportes/csv/por_recuperar.php">Equipos Por Recuperar</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInventarioantena" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-fw fa-credit-card"></i>
                        <span>Inventario Antena </span></a>
                    </a>
                    <div id="collapseInventarioantena" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../../inventario/asignar/asignar_antenas.php">Asignar Antena a Técnico</a>
                        </div>
                    </div>
                </li>
                ...
                <!-- menu invenatrio onu -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInventarioonu" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-fw fa-credit-card"></i>
                        <span>Inventario ONU </span></a>
                    </a>
                    <div id="collapseInventarioonu" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../../inventario/asignar/asignar_onu.php">Asignar ONU a Técnico</a>
                        </div>
                    </div>
                </li>
                ...
                <!-- menu inventario ont -->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInventarioont" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-fw fa-credit-card"></i>
                        <span>Inventario ONT</span></a>
                    </a>
                    <div id="collapseInventarioont" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../../inventario/asignar/asignar_ont.php">Asignar ONT a Técnico</a>
                        </div>
                    </div>
                </li>
                <!-- menu inventario bandera-->
                <li class="nav-item">
                    <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInventariobandera" aria-expanded="true" aria-controls="collapsePages">
                        <i class="fas fa-fw fa-credit-card"></i>
                        <span>Inventario Bandera</span></a>
                    </a>
                    <div id="collapseInventariobandera" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="../../inventario/asignar/asignar_banderas.php">Asignar Bandera a Técnico</a>
                        </div>
                    </div>
                </li>
